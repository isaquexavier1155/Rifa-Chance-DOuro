...
<!-- Conteudo Central -->
    <div class="conteudo-central">
        ...
        <div class="centralized-content2">
            ...
            <br><br>
            <strong id="arrecadacao">ID Rifa:  R$ {{ $idd_campanha }} </strong>
            <br><br>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Você será redirecionado ao início.
            </div>
...
<script>
  ...
  function atualizarStatusCobranca() {
    fetch('/consult-qrcode-payment-tikets')
  ...
  function redirecionarParaHome() {
    window.location.href = '/comprar-bilhetes/{{ $idd_campanha }}';
  }
</script>
