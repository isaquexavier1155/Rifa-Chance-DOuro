...
Route::get('/consult-qrcode-payment-tikets', [CompradorController::class, 'consultQrCodePaymentTikets'])->middleware('auth');


//ROTA PARA ENVIO DE CONTATO E SUJESTÕES
//Route::post('/enviar_email', [ContatoController::class, 'enviarEmail']);

//ROTA PARA ENVIO DE CONTATO E SUJESTÕES teste 3
Route::get('/contact', [ContatoController::class, 'index'])->name('contact.index');
